...
class Students
{
    ...
    Students(String name, String id, String std, Address address)
    {
    	this.name = name;
    	this.id = id;
    	this.std = std;
    ...
    Students(String name, String id, String std)
    {
    	this.name = name;
    	this.id = id;
    	this.std = std;
 ...
 public class Aggregation
 {
	...
	public static void main(String[] args) {
		...
		Students student1 = new Students("Sri", "vh1245", "XII");
        student1.displayDetails();
        System.out.println();
           
        Students student2 = new Students("Sri", "vh1245", "XII", address1);
