...
class StudentData
{
	...
	void studentInfo()
	{
		...
		//System.out.println("this.obj   "+this.student.name);// Exception : this.student is null
	}
	...
	void studentLibraryDatabase() 
	{
		...
		System.out.println("this.obj   "+this.student.name); // this.student.name - student1_libraryDB.student1.name
	}
...
public class AggregationDemo {
	...
	public static void main(String[] args) {
		...
		student1_libraryDB.studentLibraryDatabase();
